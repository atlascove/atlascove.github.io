...
$('#layer_toggle').on('click', function(){
  ...
  if (currentLayer == 1){
    ...
    $('#attribution').empty().html('<a style="color:white;background-color:black" href="https://www.maptiler.com/copyright/" target="_blank">© MapTiler</a><br> Bing © 2021 Microsoft Corporation');
    currentLayer = 0;
    console.log('switch layer');
  }
  else if (currentLayer == 0){
    map.setStyle('https://api.maptiler.com/maps/streets/style.json?key=LVXocV2Y6nX6vEqq67iz');
    $('#attribution').empty().html('<a style="color:white;background-color:black" href="https://www.maptiler.com/copyright/" target="_blank">© MapTiler</a><br> <a style="color:white;background-color:black" href="https://www.openstreetmap.org/copyright" target="_blank">© OpenStreetMap contributors</a>');
    currentLayer = 1;
...
function takeSnapshot() {
  ...
  getCanvasBlob(canvas).then(function (blob) {
    ...
    console.log(blob);
    image.style = "height: 100%; width:100%; display: block;"
